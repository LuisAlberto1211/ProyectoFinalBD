...
CREATE TABLE REVISOR(
  ...
  DIAS_RESTANTES AS (FECHA_FIN - sysdate) VIRTUAL,
...
CREATE TABLE STATUS_ARTICULO(
  ...
  ACTIVO              NUMBER (1,0) NOT NULL DEFAULT 1,
  CONSTRAINT STATUS_ARTICULO_ACTIVO_CHECK CHECK (ACTIVO IN (0,1))
);
...
CREATE TABLE SUSCRIPTOR(
  ...
  FECHA_SUSCRIPCION DATE NOT NULL DEFAULT sysdate,
  VIGENCIA_MESES AS ( MONTHS_BETWEEN(FECHA_SUSCRIPCION, sysdate) ) VIRTUAL
);
