...
CREATE TABLE EDITOR_AREA_INTERES(
  ...
  CONSTRAINT EDITOR_INTERES_EMP_ID_FK FOREIGN KEY (EMPLEADO_ID) REFERENCES EMPLEADO(EMPLEADO_ID),
...
CREATE TABLE HISTORICO_STATUS_ARTICULO(
  ...
  ARTICULO_ID                   NUMBER(10,0) NOT NULL CONSTRAINT HISTORICO_STATUS_ARTICULO_ART_ID_FK REFERENCES ARTICULO(ARTICULO_ID),
  STATUS_ARTICULO_ID            NUMBER(10,0) NOT NULL CONSTRAINT HISTORICO_STATUS_ARTICULO_ST_ID_FK REFERENCES STATUS_ARTICULO(STATUS_ARTICULO_ID),
...
CREATE TABLE SUSCRIPTOR(
  ...
  VIGENCIA_MESES    NUMBER(2,0) NOT NULL
);
